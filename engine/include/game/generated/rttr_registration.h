...
RTTR_REGISTRATION
{
    ...
    rttr::registration::class_<PlayerRenderer>("PlayerRenderer")
        ...
        .property("show_zone_effect", &PlayerRenderer::show_zone_effect)
        .property("trail_color", &PlayerRenderer::trail_color)
        .property("trail_count", &PlayerRenderer::trail_count)
        .property("trail_length", &PlayerRenderer::trail_length)
        .property("trail_speed", &PlayerRenderer::trail_speed)
        .property("trail_thickness", &PlayerRenderer::trail_thickness)
        .property("use_outline", &PlayerRenderer::use_outline)
        .property("zone_effect_duration", &PlayerRenderer::zone_effect_duration)
        .property("zone_effect_size", &PlayerRenderer::zone_effect_size)
        .property("zone_effect_speed", &PlayerRenderer::zone_effect_speed);
