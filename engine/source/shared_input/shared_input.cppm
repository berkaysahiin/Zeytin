...
// Input state shared between editor and engine
export struct SharedInputState {
    // Mouse state (in virtual coordinates 0-1920, 0-1080)
    float mouse_x;
    float mouse_y;
    float mouse_delta_x;
    float mouse_delta_y;
...
public:
	...
	// call at start of frame to reset pressed/released states
    void begin_frame();  
	...
	// call at end of frame to increment counter
    void end_frame();  
