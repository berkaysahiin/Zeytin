...
module zeytin.common.message.editor_to_engine.engine_start_confirmed;

std::string EditorEngineStartConfirmedMessage::get_type() const {
    return "engine_start_confirmed";
}

std::string EditorEngineStartConfirmedMessage::as_json() const {
...
bool EditorEngineStartConfirmedMessage::from_json(const rapidjson::Value& message) {
    if (!message.IsObject()) {
        return false;
    }
